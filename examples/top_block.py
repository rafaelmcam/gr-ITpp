...
# Title: Top Block
# Generated: Sat Sep  8 12:25:33 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_tags_strobe_0 = blocks.tags_strobe(gr.sizeof_float*1, pmt.intern("TEST"), 1, pmt.intern("strobe"))
        self.blocks_float_to_uchar_0 = blocks.float_to_uchar()
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 5)
        self.ITpp_Hamming_Encoder_0 = ITpp.Hamming_Encoder()

        ##################################################
        # Connections
        ##################################################
        self.connect((self.ITpp_Hamming_Encoder_0, 0), (self.blocks_unpack_k_bits_bb_0, 0))
        ...
        self.connect((self.blocks_float_to_uchar_0, 0), (self.blocks_throttle_0, 0))
